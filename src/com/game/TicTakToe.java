...
public class TicTakToe implements ActionListener {
		...
		for(int i = 0; i < 9; i++) {
			if(e.getSource() == buttons[i]) {
				if(player1_turn) {
					...
					if(buttons[i].getText()=="") {
						buttons[i].setForeground(new Color(0, 20, 200));
						buttons[i].setText("O");
						player1_turn = true;
	...
	public void xWins(int a, int b, int c) {
		buttons[a].setBackground(new Color(87, 237, 100));
		buttons[b].setBackground(new Color(87, 237, 100));
		buttons[c].setBackground(new Color(87, 237, 100));
		for(int i = 0; i<9 ; i++) {
	...
	public void oWins(int a, int b, int c) {
		buttons[a].setBackground(new Color(163, 163, 163));
		buttons[b].setBackground(new Color(163, 163, 163));
		buttons[c].setBackground(new Color(163, 163, 163));
		for(int i = 0; i<9 ; i++) {
			buttons[i].setEnabled(false);
		}
